...
- **نشست تخصصی روانشناختی از مِه تا وضوح با حضور مهیار پویامهر:** هدایت‌شده توسط **دکتر مهیار پویامهر** (دکترای روان‌شناسی بالینی دانشگاه شیراز) برای واکاوی عدم‌قطعیت و عبور از درماندگی شغلی در گروه‌های کوچک هم‌مسیر.
- **پنل گفت‌وگو و انتقال تجربه:** با همراهی **یاسین همتی** (رئیس هیئت‌مدیره شرکت تأمین آلیاژ کارا صنعت)، **امیر کریمی** (عضو تیم اجرایی فرانت‌چپتر) و **پویا صبرآموز** (مدیرعامل و مدیر فناوری سابق) پیرامون درک پارادایم جدید بازار کار تک و هوش مصنوعی.
