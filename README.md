...
- **پنل گفت‌وگو و انتقال تجربه:** با همراهی **صالح شجاعی** (بنیان‌گذار فرانت‌چپتر)، **امیر کریمی** (عضو تیم اجرایی فرانت‌چپتر) و **پویا صبرآموز** (مدیرعامل و مدیر فناوری سابق) پیرامون درک پارادایم جدید بازار کار تک و هوش مصنوعی.
