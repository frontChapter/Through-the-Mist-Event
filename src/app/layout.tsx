...
export const metadata: Metadata = {
  ...
  description:
    'رویداد تعاملی فرانت‌چپتر برای طراحان، برنامه‌نویسان و متخصصان محصول؛ مواجهه با بحران هوش مصنوعی، نشست تخصصی روانشناختی از مِه تا وضوح با حضور مهیار پویامهر و ترسیم مسیرهای عملی آینده حرفه‌ای در کارخانه نوآوری آزادی.',
...
const jsonLdEvent = {
  ...
  description:
    'رویدادی تعاملی برای طراحان، برنامه‌نویسان و متخصصان وب؛ مواجهه با عدم‌قطعیت و موج هوش مصنوعی، نشست تخصصی روانشناختی از مِه تا وضوح با حضور مهیار پویامهر و پنل گفت‌وگوی تخصصی در کارخانه نوآوری آزادی.',
