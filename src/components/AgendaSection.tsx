...
const AGENDA_ITEMS: AgendaItem[] = [
  ...
  },
  {
    number: "۰۴",
    time: "۱۵:۴۵–۱۷:۱۵",
    title: "نشست تخصصی روانشناختی از مِه تا وضوح با حضور مهیار پویامهر",
    description:
  ...
  },
  {
    ...
    description:
      "صالح شجاعی، امیر کریمی و پویا صبرآموز، بدون فیلتر، از پارادایم‌های تازه‌ی بازار کار می‌گن؛ همون سؤال‌هایی که تو هم داری، اینجا پرسیده می‌شه.",
    category: "پنل تخصصی",
  },
  {
    number: "۰۸",
